...
public class ERPMachine {
    ...
    public void aFactoryInTheERPSystemWithTheNametheplantExists() throws Throwable {
        erp.addProcessingPlant("theplant");
    }
