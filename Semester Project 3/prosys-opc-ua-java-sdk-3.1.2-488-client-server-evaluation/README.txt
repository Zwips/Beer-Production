...
If you are migrating an existing application that is using version 2.x of the Prosys OPC UA Java SDK, you can check the Migration Guide 
available in the 'tutorial' folder of the SDK distribution package. It explains the differences in 3.x and helps you to modify your application respectively.
